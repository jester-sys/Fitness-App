...
Persnol Fitness is a home workout app illustrating Android development best practices: Hilt, Preferences DataStore, WorkManager, DataBinding, Kotlin Coroutines & Flow.

## Overview
  + Persnol Fitness has 3 main destinations that can be accessible from anywhere in the app by the ```Bottom Navigation``` set with Navigation Components.
...
## Design
+ Persnol Fitness is built with Material Components for Android.
